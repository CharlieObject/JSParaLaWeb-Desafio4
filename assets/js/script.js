// Arreglo de objetos alquiler index
...
const dptos_venta = document.querySelector("#div_venta")
const dptos_alquiler = document.querySelector("#div_alquiler")

let contador = 0;


// Ciclo alquiler index
